    ...
    Page {
        Container {
            ...
            Label {
                ...
                text: qsTr("There are no pushes currently.")
                textStyle {
            ...
            ListView {
                ...
                onTriggered: {
                    ...
                    _pushAPIHandler.selectItem(dataModel.data(indexPath))
                }
            }
        }
        ...
        actions: [
            ...
            ActionItem {
                ...
                enabled: !_pushAPIHandler.isSuccessRegister
                onTriggered: {
        ...
        Page {
            ...
            actions: [
                ActionItem {
                    ...
                    imageSource: "asset:///images/actionbar/deleteallicon.png"
                    onTriggered: {
                        _pushAPIHandler.deleteCurrentPush();
                        navPane.pop();
                    }
                }
            ]

...
Sample_users::Sample_users(bb::cascades::Application *app) :
		QObject(app) {
	...
	qmlRegisterType<QBNetwork>("com.example.Sample_users.QBNetwork", 1, 0,
			"QBNetwork");
 ...
 * Set object
 */
void Sample_users::setObjectQBNetwork(QBNetwork *qbnetwork_) {
 ...
 * Get display height
 */
int Sample_users::displayHeight() {
	bb::device::DisplayInfo display;
